    ...
    case facialHair of
        ...
        MoustacheFancy hairColor ->
            g [ id "Facial-Hair/Moustache-Fancy", transform "translate(49, 72)" ]
                [ defs []
                    [ path [ d "M84,69 C77,66 68,65 62,67 C57,69 52,76 43,73 C42,73 42,73 42,73 C43,78 51,81 54,81 C65,82 74,73 84,72 C94,73 103,82 114,81 C117,81 125,78 126,73 C126,73 126,73 125,73 C116,76 111,69 106,67 C100,65 91,66 84,69 Z", id "facialHairPath" ] []
                    ]
                , mask [ id "facialHairMask", fill "white" ]
                    [ use [ xlinkHref "#facialHairPath" ] []
                    ]
                , use [ id "Moustache-U-a-Question", fill "#28354B", fillRule "evenodd", xlinkHref "#facialHairPath" ] []
                , HairColor.view { maskId = "facialHairMask", hairColor = hairColor }
                ]
        ...
        MoustacheMagnum hairColor ->
            g [ id "Facial-Hair/Moustache-Magnum", transform "translate(49, 72)" ]
                [ defs []
                    [ path [ d "M84,75 C83,76 83,76 82,77 C73,82 64,77 59,78 C56,78 53,79 52,78 C51,76 55,65 65,63 C72,62 81,64 84,67 C86,64 96,62 103,63 C113,65 117,76 116,78 C115,79 112,78 109,78 C104,77 95,82 86,77 C85,76 85,76 84,75 Z", id "facialHairPath" ] []
                    ]
                , mask [ id "facialHairMask", fill "white" ]
                    [ use [ xlinkHref "#facialHairPath" ] []
                    ]
                , use [ id "Hey...", fill "#28354B", fillRule "evenodd", xlinkHref "#facialHairPath" ] []
                , HairColor.view { maskId = "facialHairMask", hairColor = hairColor }
                ]


beardMedium : HairColor -> Svg msg
beardMedium hairColor =
    g [ id "Facial-Hair/Beard-Medium", transform "translate(49, 72)" ]
        [ defs []
            [ path [ d "M105,94 C101,100 98,96 94,93 C92,91 88,89 85,89 C81,89 77,91 75,93 C71,96 68,100 64,94 C61,90 62,83 65,79 C69,73 74,76 80,75 C82,75 83,75 85,74 C86,75 87,75 89,75 C95,76 100,73 104,79 C107,83 108,90 105,94 M140,26 C137,40 135,54 133,69 C132,72 132,75 131,78 C131,78 131,80 130,81 C129,82 125,77 124,76 C121,73 119,71 116,68 C109,64 102,62 94,61 C91,61 87,61 84,63 C81,61 77,61 74,61 C66,62 59,64 52,68 C49,71 47,73 44,76 C43,77 39,82 38,81 C37,80 37,78 37,78 C36,75 36,72 35,69 C33,54 31,40 28,26 C27,26 26,45 26,46 C25,54 25,61 25,68 C26,80 28,95 37,105 C45,113 58,115 68,120 C70,121 71,122 73,122 C75,124 79,125 84,125 C89,125 93,124 95,122 C97,121 99,121 100,120 C110,115 123,113 131,105 C140,95 142,80 143,68 C143,61 143,54 142,46 C142,45 141,26 140,26 Z", id "beardPath" ] []
            ]
        , mask [ id "beardMask", fill "white" ]
            [ use [ xlinkHref "#beardPath" ] [] ]
        , use [ id "Beardness", fill "#252E32", fillRule "evenodd", xlinkHref "#beardPath" ] []
        , HairColor.view { maskId = "beardMask", hairColor = hairColor }
        ]


beardLight : HairColor -> Svg msg
beardLight hairColor =
    g [ transform "translate(49, 72)" ]
        [ defs []
            [ path [ d "M101,98 C99,100 96,101 93,101 C92,101 90,96 84,96 C78,96 76,101 75,101 C72,101 69,100 67,98 C62,94 58,88 60,81 C62,78 64,74 67,73 C71,72 76,73 80,72 C82,72 83,72 84,71 C85,72 86,72 88,72 C92,73 97,72 101,73 C104,74 106,78 108,81 C110,88 106,94 101,98 M140,26 C137,34 138,45 137,54 C137,61 135,72 129,76 C126,79 120,83 116,81 C113,81 112,72 108,69 C104,66 99,64 93,64 C91,64 86,64 84,66 C82,64 77,64 75,64 C69,64 64,66 60,69 C56,72 55,81 52,81 C48,83 42,79 39,76 C33,72 31,61 31,54 C30,45 31,34 28,26 C26,26 27,42 27,42 L27,62 C27,78 37,101 58,109 C63,112 75,115 84,115 C93,115 105,112 110,110 C131,101 141,78 141,62 L141,42 C141,42 142,26 140,26", id "beardPath" ] []
            ]
        , mask [ id "beardMask", fill "white" ]
            [ use [ xlinkHref "#beardPath" ] [] ]
        , use [ id "Lite-Beard", fill "#331B0C", fillRule "evenodd", xlinkHref "#beardPath" ] []
        , HairColor.view { maskId = "beardMask", hairColor = hairColor }
        ]
