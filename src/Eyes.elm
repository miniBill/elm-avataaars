...
import Svg.Attributes as A exposing (cx, cy, d, fill, fillOpacity, fillRule, id, r, transform, xlinkHref)
...
close =
    g [ fillOpacity "1" ]
        [ path [ d "M16,32 C18,29 22,26 27,26 C32,26 36,29 38,32 C38,34 38,34 37,34 C34,32 31,30 27,30 C23,30 20,32 17,34 C17,34 16,34 16,32 Z", id "Closed-Eye", transform "translate(27, 38) scale(1, -1) translate(-27, -30) " ] []
        , path [ d "M74,32 C76,29 80,26 85,26 C90,26 94,29 96,32 C96,34 96,34 95,34 C92,32 89,30 85,30 C81,30 78,32 75,34 C75,34 74,34 74,32 Z", id "Closed-Eye", transform "translate(85, 38) scale(1, -1) translate(-85, -30) " ] []
        ]
...
cry =
    g [ transform "translate(0, 8)" ]
        [ circle [ id "Eye", fillOpacity "1", fill "#000000", fillRule "evenodd", cx "30", cy "22", r "6" ] []
        , path [ d "M25,27 C25,27 19,34 19,38 C19,42 22,44 25,44 C28,44 31,42 31,38 C31,34 25,27 25,27 Z", fill "#92D9FF", fillRule "nonzero" ] []
        , circle [ id "Eye", fillOpacity "1", fill "#000000", fillRule "evenodd", cx "82", cy "22", r "6" ] []
        ]
...
defaultEyes =
    g [ fillOpacity "1" ]
        [ circle [ id "Eye", cx "30", cy "30", r "6" ] []
        , circle [ id "Eye", cx "82", cy "30", r "6" ] []
        ]


dizzy : Svg msg
dizzy =
    g [ transform "translate(0, 8)", fillOpacity "1", fillRule "nonzero" ]
...
eyeRoll =
    g [ transform "translate(0, 8)" ]
        ...
        , circle [ id "Eye", fillOpacity "1", fill "#000000", cx "30", cy "14", r "6" ] []
        , circle [ id "Eye", fillOpacity "1", fill "#000000", cx "82", cy "14", r "6" ] []
        ]


happy : Svg msg
happy =
    g [ transform "translate(0, 8)", fillOpacity "1" ]
...
hearts : Svg msg
hearts =
    g [ transform "translate(0, 8)", fillOpacity "0.8", fillRule "nonzero", fill "#FF5353" ]
...
squint =
    g []
        ...
        , g [ transform "translate(16, 21)" ]
            [ use [ id "The-white-stuff", fill "#FFFFFF", xlinkHref "#squintPath" ] []
            , circle [ fillOpacity "1", fill "#000000", A.mask "url(#squintMask)", cx "14", cy "10", r "6" ] []
            ]
        , g [ transform "translate(68, 21)" ]
            [ use [ id "Eyeball-Mask", fill "#FFFFFF", xlinkHref "#squintPath" ] []
            , circle [ fillOpacity "1", fill "#000000", A.mask "url(#squintMask)", cx "14", cy "10", r "6" ] []
            ]
        ]
...
surprised =
    g []
        ...
        , circle [ fillOpacity "1", fill "#000000", cx "30", cy "30", r "6" ] []
        , circle [ fillOpacity "1", fill "#000000", cx "82", cy "30", r "6" ] []
        ]
...
winkWacky =
    g [ transform "translate(0, 8)" ]
        ...
        , circle [ fillOpacity "1", fill "#000000", cx "82", cy "22", r "6" ] []
        , path [ d "M16,25 C18,22 22,19 27,19 C32,19 36,22 38,25 C38,27 38,27 37,27 C34,25 31,23 27,23 C23,23 20,25 17,27 C17,27 16,27 16,25 Z", fillOpacity "1", fill "#000000" ] []
        ]
