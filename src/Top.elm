...
turban hatColor =
    standard
        ...
        , HatColor.view { maskId = "topMask", hatColor = hatColor }
...
winterHat1 hatColor =
    standard
        ...
        , rect [ id "topPath2", x "74", y "50", width "118", height "36", rx "8", fill "#F4F4F4" ] []
        ]
...
winterHat2 hatColor =
    standard
        [ g [ transform "translate(60, 0)" ]
            ...
            , HatColor.view { maskId = "topMask2", hatColor = hatColor }
            , rect [ fillOpacity "0.2", fill "#000000", x "-1", y "21", width "146", height "46", A.mask "url(#topMask2)" ] []
...
winterHat4 hatColor =
    standard
        [ g [ id "hat", transform "translate(64, 4)" ]
            [ mask [ id "topMask2", fill "white" ]
...
longHairCurvy hairColor =
    ...
    , g [ transform "translate(25, 16)" ]
        ...
        , HairColor.view { maskId = "topMask", hairColor = hairColor }
        , path [ d "M63,184 C70,175 62,148 56,138 C73,130 106,132 156,142 C151,151 149,159 150,166 C145,171 142,177 139,183 L104,192 C82,194 68,192 63,184 Z", fillOpacity "0.24", fill "#000000", A.mask "url(#topMask)" ] []
        ]
...
longHairFrida accessory facialHair =
    ...
    g []
        [ defs []
            [ filter [ x "-3.8%", y "-6.7%", width "107.7%", height "126.7%", filterUnits "objectBoundingBox", id "topFilter5" ] stdFilter
            , filter [ x "-6.7%", y "-3.4%", width "113.3%", height "113.8%", filterUnits "objectBoundingBox", id "topFilter6" ] stdFilter
            , filter [ x "-6.7%", y "-3.4%", width "113.3%", height "113.8%", filterUnits "objectBoundingBox", id "topFilter7" ] stdFilter
            , filter [ x "-3.8%", y "-3.8%", width "107.7%", height "115.4%", filterUnits "objectBoundingBox", id "topFilter1" ] stdFilter
            , filter [ x "-2.5%", y "-2.5%", width "105.0%", height "110.0%", filterUnits "objectBoundingBox", id "topFilter2" ] stdFilter
            , filter [ x "-2.7%", y "-2.7%", width "105.4%", height "110.8%", filterUnits "objectBoundingBox", id "topFilter3" ] stdFilter
            , filter [ x "-1.8%", y "-1.9%", width "103.6%", height "107.4%", filterUnits "objectBoundingBox", id "topFilter4" ] stdFilter
        ...
        , g [ transform "translate(67, 0)" ]
            [ g [ id "hoja", A.filter "url(#topFilter5)", transform "translate(120, 65) scale(1, -1) rotate(-20) translate(-120, -65) translate(107, 57)" ]
            ...
            , g [ A.filter "url(#topFilter1)", transform "translate(13, 42) scale(-1, 1) translate(-13, -42) translate(0, 29)" ]
            ...
            , g [ A.filter "url(#topFilter2)", transform "translate(20, 16)" ]
            ...
            , g [ A.filter "url(#topFilter3)", transform "translate(89, 26)" ]
            ...
            , g [ A.filter "url(#topFilter4)", transform "translate(48, 0)" ]
...
longHairShavedSides accessory facialHair =
    g []
        ...
        , path [ d "M116,40 L146,40 C171,40 192,61 192,86 L192,154 C192,181 211,204 223,226 C234,248 215,268 196,277 C191,279 186,280 180,280 L135,280 C79,280 70,216 68,147 L70,84 C71,59 91,40 116,40 Z", fill "#CCB55A", A.mask "url(#topMask)" ]
            []
        , path
