...
blazerShirt =
    g [ id "Clothing/Blazer-+-Shirt", transform "translate(0, 170)" ]
        ...
        , g [ id "Blazer", transform "translate(32, 28)" ]
            [ path [ d "M69,1 C31,3 0,34 0,73 L0,73 L0,82 L69,82 C66,70 64,56 64,41 C64,26 66,13 69,1 Z M132,82 L200,82 L200,73 C200,35 170,3 132,1 C135,13 137,26 137,41 C137,56 135,70 132,82 Z", id "Saco", fill "#3A4C5A" ]
                []
            , path [ d "M149,58 L159,51 L159,51 C160,50 162,50 163,51 L170,56 L149,58 Z", id "Pocket-hanky", fill "#E6E6E6" ]
                []
            , path [ d "M69,0 C65,19 67,47 74,82 L58,82 L44,46 L50,37 L44,31 L63,1 C65,0 67,0 69,0 Z", id "Wing", fill "#2F4351" ]
                []
            , path [ d "M151,0 C147,19 149,47 156,82 L140,82 L126,46 L132,37 L126,31 L145,1 C147,0 149,0 151,0 Z", id "Wing", fill "#2F4351", transform "translate(141, 41) scale(-1, 1) translate(-141, -41) " ]
                []
            ]
        ]
...
blazerSweater =
    g [ id "Clothing/Blazer-+-Sweater", transform "translate(0, 170)" ]
        ...
        , use [ id "Clothes", fill "#E6E6E6", fillRule "evenodd", xlinkHref "#blazerPath" ]
            []
        , g [ id "Color/Palette/Black", A.mask "url(#blazerMask)", fillRule "evenodd", fill "#262E33" ]
            [ rect [ id "🖍Color", x "0", y "0", width "264", height "110" ]
                []
            ]
        , g [ id "Blazer", strokeWidth "1", fillRule "evenodd", transform "translate(32, 28)" ]
            [ path [ d "M69,1 C31,3 0,34 0,73 L0,82 L69,82 C66,70 64,56 64,41 C64,26 66,13 69,1 Z M132,82 L200,82 L200,73 C200,35 170,3 132,1 C135,13 137,26 137,41 C137,56 135,70 132,82 Z", id "Saco", fill "#3A4C5A" ]
                []
            , path [ d "M149,58 L159,51 L159,51 C160,50 162,50 163,51 L170,56 L149,58 Z", id "Pocket-hanky", fill "#E6E6E6" ]
                []
            , path [ d "M69,0 C65,19 67,47 74,82 L58,82 L44,46 L50,37 L44,31 L63,1 C65,0 67,0 69,0 Z", id "Wing", fill "#2F4351" ]
        ...
        , path [ d "M156,22 C163,26 167,33 167,40 C167,47 163,54 156,59 L150,54 L145,54 L146,51 L146,51 C152,48 156,43 156,37 L156,22 Z M108,22 C101,26 97,33 97,40 C97,47 101,54 108,59 L114,54 L119,54 L118,51 L118,51 C112,48 108,43 108,37 L108,22 Z", id "Collar", fill "#F2F2F2", fillRule "evenodd" ]
            []
        ]
...
collarSweater color =
    g [ id "Clothing/Collar-+-Sweater", transform "translate(0, 170)" ]
        ...
        , use [ id "Clothes", fill "#E6E6E6", fillRule "evenodd", xlinkHref "#sweaterPath" ]
            []
        , colors { maskId = "sweaterMask", color = color }
        , path
            [ d "M156,22 C162,27 166,33 166,40 C166,47 162,54 155,58 L150,54 L145,54 L146,51 L146,51 C152,48 156,43 156,37 L156,22 Z M108,22 C101,26 97,33 97,40 C97,47 101,54 108,59 L114,54 L119,54 L118,51 L118,51 C112,48 108,43 108,37 L108,22 Z", id "Collar", fill "#F2F2F2", fillRule "evenodd" ]
            []
        ]
...
graphicsShirt color graphics =
    g [ id "Clothing/Graphic-Shirt", transform "translate(0, 170)" ]
        ...
        , use [ id "Clothes", fill "#E6E6E6", fillRule "evenodd", xlinkHref "#graphicsPath" ]
            []
...
hoodie color =
    g [ id "Clothing/Hoodie", transform "translate(0, 170)" ]
        ...
        , use [ id "Hoodie", fill "#B7C1DB", fillRule "evenodd", xlinkHref "#HoodiePath" ] []
        , colors { maskId = "HoodieMask", color = color }
        , path [ d "M102,62 L102,110 L95,110 L95,58 C97,59 100,61 102,62 Z M169,58 L169,99 C169,100 167,102 166,102 C164,102 162,100 162,99 L162,62 C164,61 167,59 169,58 Z", id "Straps", fill "#F4F4F4", fillRule "evenodd", A.mask "url(#HoodieMask)" ]
            []
        , path [ d "M91,13 C76,16 66,21 66,32 C66,52 99,68 132,68 C165,68 199,52 199,32 C199,21 188,16 173,13 C182,16 188,22 188,31 C188,51 160,68 132,68 C104,68 76,51 76,31 C76,22 82,16 91,13 Z", id "Shadow", fillOpacity "0.16", fill "#000000", fillRule "evenodd", A.mask "url(#HoodieMask)" ]
            []
        ]
...
overall color =
    g [ id "Clothing/Overall", transform "translate(0, 170)" ]
        ...
        , use [ id "Overall", fill "#B7C1DB", fillRule "evenodd", xlinkHref "#OverallPath" ]
            []
...
shirtCrewNeck color =
    g [ id "Clothing/Shirt-Crew-Neck", transform "translate(0, 170)" ]
        ...
        , use [ id "Clothes", fill "#E6E6E6", fillRule "evenodd", xlinkHref "#crewNeckPath" ]
            []
        , colors { maskId = "crewMask", color = color }
        , g [ id "Shadowy", opacity "0.6", strokeWidth "1", fillRule "evenodd", A.mask "url(#crewMask)", fillOpacity "0.16", fill "#000000" ]
            [ g [ transform "translate(92, 4)", id "Hola-👋\u{1F3FC}" ]
                [ ellipse [ cx "41", cy "28", rx "40", ry "27" ]
                    []
                ]
            ]
...
shirtScoopNeck color =
    g [ id "Clothing/Shirt-Scoop-Neck", transform "translate(0, 170)" ]
        ...
        , use [ id "Clothes", fill "#E6E6E6", fillRule "evenodd", xlinkHref "#ScoopPath" ]
            []
...
colors { maskId, color } =
    g [ id "Color/Palette/Gray-01", A.mask <| "url(#" ++ maskId ++ ")", fillRule "evenodd", fill <| colorToHex color ]
        [ rect [ id "🖍Color", x "0", y "0", width "264", height "110" ]
            []
        ]
