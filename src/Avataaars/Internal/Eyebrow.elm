...
default : List (Svg msg)
default =
    [ path [ d "M4,11 C8,6 18,3 28,5 C29,5 30,4 30,3 C30,2 30,1 28,1 C18,-2 5,2 0,9 C-0,10 -0,11 1,12 C2,12 3,12 4,11 Z", transform "translate(12, 6)" ] []
    , path [ d "M62,11 C66,6 76,3 86,5 C87,5 88,4 88,3 C88,2 88,1 86,1 C76,-2 63,2 58,9 C58,10 58,11 59,12 C60,12 61,12 62,11 Z", transform "translate(85, 12) scale(-1, 1) translate(-73, -6) " ] []
    ]


defaultNatural : List (Svg msg)
defaultNatural =
...
raisedExcited : List (Svg msg)
raisedExcited =
    [ path [ d "M4,17 C5,8 18,1 27,5 C28,6 29,5 30,4 C30,3 30,2 29,2 C17,-4 2,4 0,17 C-0,18 1,19 2,19 C3,19 4,18 4,17 Z", transform "translate(12, 0)" ] []
    , path [ d "M62,17 C63,8 76,1 85,5 C86,6 87,5 88,4 C88,3 88,2 87,2 C75,-4 60,4 58,17 C58,18 59,19 60,19 C61,19 62,18 62,17 Z", transform "translate(85, 9) scale(-1, 1) translate(-73, -9) " ] []
    ]


raisedExcitedNatural : List (Svg msg)
raisedExcitedNatural =
    [ path [ d "M23,2 L24,1 C29,-1 37,-0 42,2 C42,3 42,3 41,3 C26,2 16,12 13,18 C13,18 13,18 12,18 C10,13 17,4 23,2 Z" ] []
    , path [ d "M81,2 L82,1 C87,-1 95,-0 100,2 C100,3 100,3 99,3 C84,2 74,12 71,18 C71,18 71,18 70,18 C68,13 75,4 81,2 Z", transform "translate(85, 9) scale(-1, 1) translate(-85, -9) " ] []
    ]


sadConcerned : List (Svg msg)
sadConcerned =
...
sadConcernedNatural : List (Svg msg)
sadConcernedNatural =
